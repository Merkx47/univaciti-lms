...
const modules = [
  { name: "QA Fundamentals", hours: "15", description: "Core concepts of quality assurance and testing" },
  { name: "Test Planning & Design", hours: "20", description: "Creating comprehensive test plans and strategies" },
  { name: "Manual Testing", hours: "25", description: "Functional, regression, and exploratory testing" },
  { name: "Automation Testing", hours: "30", description: "Building automated test suites with Selenium" },
  { name: "API Testing", hours: "20", description: "Testing REST APIs using Postman and frameworks" },
  { name: "Performance Testing", hours: "20", description: "Load and stress testing with JMeter" },
  { name: "CI/CD Integration", hours: "20", description: "Integrating tests into continuous pipelines" },
];

const skills = [
  { title: "Test Planning", description: "Create comprehensive test plans and test cases." },
  { title: "Manual Testing", description: "Execute functional, regression, and exploratory testing." },
  { title: "Automation", description: "Build automated test suites using Selenium and other tools." },
  { title: "API Testing", description: "Test REST APIs using Postman and automated frameworks." },
  { title: "Performance", description: "Conduct load and stress testing with JMeter." },
  { title: "Bug Tracking", description: "Effectively document and track defects." },
  { title: "CI/CD", description: "Integrate testing into continuous integration pipelines." },
];
...
const tools = ["Selenium", "Cypress", "Postman", "JMeter", "Cucumber", "Jenkins", "JIRA"];
          ...
          >
            <div className="flex flex-col sm:flex-row items-center gap-6 mb-6">
              <div className="w-20 h-20 rounded-2xl bg-white/10 flex items-center justify-center">
                <QAIcon className="w-12 h-12 text-white" />
              </div>
              <div className="text-center sm:text-left">
                <h1 className="text-3xl sm:text-4xl font-bold text-white mb-1">Quality Assurance</h1>
                <p className="text-lg text-white/80">Software Testing Specialization</p>
              </div>
            </div>
