...
// AI & Machine Learning - Brain/chip icon
function RobotIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="currentColor">
      <path d="M21 10.12h-1.22c-.22-.87-.61-1.67-1.14-2.36l.86-.86c.39-.39.39-1.02 0-1.41l-.71-.71a.996.996 0 0 0-1.41 0l-.86.86c-.69-.52-1.48-.91-2.35-1.14V3.28c0-.55-.45-1-1-1h-1c-.55 0-1 .45-1 1v1.22c-.87.23-1.66.61-2.35 1.14l-.86-.86a.996.996 0 0 0-1.41 0l-.71.71c-.39.39-.39 1.02 0 1.41l.86.86c-.52.69-.91 1.49-1.14 2.36H3c-.55 0-1 .45-1 1v1c0 .55.45 1 1 1h1.22c.23.87.61 1.67 1.14 2.36l-.86.86c-.39.39-.39 1.02 0 1.41l.71.71c.39.39 1.02.39 1.41 0l.86-.86c.69.52 1.48.91 2.35 1.14v1.22c0 .55.45 1 1 1h1c.55 0 1-.45 1-1v-1.22c.87-.23 1.66-.61 2.35-1.14l.86.86c.39.39 1.02.39 1.41 0l.71-.71c.39-.39.39-1.02 0-1.41l-.86-.86c.52-.69.91-1.49 1.14-2.36H21c.55 0 1-.45 1-1v-1c0-.55-.45-1-1-1zm-9.5 5.5c-2.49 0-4.5-2.01-4.5-4.5s2.01-4.5 4.5-4.5 4.5 2.01 4.5 4.5-2.01 4.5-4.5 4.5z"/>
      <circle cx="11.5" cy="11.12" r="2.5"/>
    </svg>
  );
}
