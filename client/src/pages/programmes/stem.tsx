        ...
        return (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="p-4 rounded-lg border border-slate-200 dark:border-slate-600 bg-slate-50 dark:bg-slate-700/30 text-center">
                <Rocket className="w-10 h-10 mx-auto mb-2" style={{ color: THEME_PRIMARY }} />
                <h3 className="font-medium mb-1 text-slate-900 dark:text-slate-100">Discovery Learning</h3>
                <p className="text-sm text-slate-600 dark:text-slate-300">Learn through exploration and hands-on experiments</p>
              </div>
              <div className="p-4 rounded-lg border border-slate-200 dark:border-slate-600 bg-slate-50 dark:bg-slate-700/30 text-center">
                <Star className="w-10 h-10 mx-auto mb-2" style={{ color: THEME_PRIMARY }} />
                <h3 className="font-medium mb-1 text-slate-900 dark:text-slate-100">Age-Appropriate</h3>
                <p className="text-sm text-slate-600 dark:text-slate-300">Curriculum designed for young minds</p>
              </div>
              <div className="p-4 rounded-lg border border-slate-200 dark:border-slate-600 bg-slate-50 dark:bg-slate-700/30 text-center">
                <Award className="w-10 h-10 mx-auto mb-2" style={{ color: THEME_PRIMARY }} />
                <h3 className="font-medium mb-1 text-slate-900 dark:text-slate-100">Certification</h3>
                <p className="text-sm text-slate-600 dark:text-slate-300">Earn recognized credentials</p>
              </div>
            </div>
            <div>
              <h3 className="font-medium mb-3" style={{ color: THEME_PRIMARY }}>Age Groups</h3>
              <div className="flex gap-4">
                <div className="flex-1 p-3 rounded-lg bg-slate-100 dark:bg-slate-700/30 text-center">
                  <span className="text-2xl font-bold" style={{ color: THEME_PRIMARY }}>10-13</span>
                  <p className="text-sm text-slate-600 dark:text-slate-300">Junior Explorers</p>
                </div>
                <div className="flex-1 p-3 rounded-lg bg-slate-100 dark:bg-slate-700/30 text-center">
                  <span className="text-2xl font-bold" style={{ color: THEME_PRIMARY }}>14-16</span>
                  <p className="text-sm text-slate-600 dark:text-slate-300">Teen Innovators</p>
                </div>
                <div className="flex-1 p-3 rounded-lg bg-slate-100 dark:bg-slate-700/30 text-center">
                  <span className="text-2xl font-bold" style={{ color: THEME_PRIMARY }}>17-18</span>
                  <p className="text-sm text-slate-600 dark:text-slate-300">Future Professionals</p>
                </div>
              </div>
            </div>
          </div>
        ...
        return (
          <div className="space-y-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h2 className="text-lg font-medium mb-2 text-slate-900 dark:text-slate-100" data-testid="text-tab-title">Mentorship & Experience</h2>
                <p className="text-slate-600 dark:text-slate-300">STEM students have opportunities to learn from industry professionals through our mentorship programme and summer internships.</p>
              </div>
            </div>
            <div className="grid grid-cols-2 gap-4">
              <div className="p-4 rounded-lg border border-slate-200 dark:border-slate-600 bg-slate-50 dark:bg-slate-700/30">
                ...
                <h3 className="font-medium mb-1 text-slate-900 dark:text-slate-100">Industry Mentors</h3>
                <p className="text-sm text-slate-600 dark:text-slate-300">Connect with professionals who guide your learning journey.</p>
              </div>
              <div className="p-4 rounded-lg border border-slate-200 dark:border-slate-600 bg-slate-50 dark:bg-slate-700/30">
                <Rocket className="w-8 h-8 mb-2" style={{ color: THEME_PRIMARY }} />
                <h3 className="font-medium mb-1 text-slate-900 dark:text-slate-100">Summer Internships</h3>
                <p className="text-sm text-slate-600 dark:text-slate-300">For advanced students (16+), explore real tech environments.</p>
              </div>
            </div>
            <div>
          ...
          <div className="space-y-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-slate-600 dark:text-slate-300">Affordable term-based pricing for quality STEM education.</p>
              </div>
            </div>
            ...
            <div className="border-2 border-slate-400 dark:border-slate-500 rounded-lg overflow-hidden">
              <div className="bg-slate-100 dark:bg-slate-700 px-4 py-3 border-b-2 border-slate-400 dark:border-slate-500">
                <h3 className="font-semibold text-sm text-slate-900 dark:text-slate-100">Programme Options</h3>
              </div>
              <div className="grid grid-cols-[1fr_auto_auto] border-b border-slate-300 dark:border-slate-600 bg-slate-50 dark:bg-slate-800/50">
                <div className="px-4 py-2 text-xs font-semibold text-slate-600 dark:text-slate-400 border-r border-slate-300 dark:border-slate-600">Option</div>
                <div className="px-4 py-2 text-xs font-semibold text-slate-600 dark:text-slate-400 w-24 text-center border-r border-slate-300 dark:border-slate-600">Price</div>
                <div className="px-4 py-2 text-xs font-semibold text-slate-600 dark:text-slate-400 w-28 text-center">Duration</div>
              </div>
              <div className="grid grid-cols-[1fr_auto_auto] border-b border-slate-300 dark:border-slate-600 bg-blue-50 dark:bg-blue-900/20">
                <div className="px-4 py-3 text-sm text-slate-700 dark:text-slate-200 border-r border-slate-300 dark:border-slate-600">Per Term</div>
                <div className="px-4 py-3 text-sm font-bold w-24 text-center border-r border-slate-300 dark:border-slate-600" style={{ color: THEME_PRIMARY }}>$500</div>
                <div className="px-4 py-3 text-xs text-slate-600 dark:text-slate-300 w-28 text-center">12 weeks</div>
              </div>
              <div className="grid grid-cols-[1fr_auto_auto]">
                <div className="px-4 py-3 text-sm text-slate-700 dark:text-slate-200 border-r border-slate-300 dark:border-slate-600">Summer Camp</div>
                <div className="px-4 py-3 text-sm font-bold text-green-600 dark:text-green-400 w-24 text-center border-r border-slate-300 dark:border-slate-600">$800</div>
                <div className="px-4 py-3 text-xs text-slate-600 dark:text-slate-300 w-28 text-center">8 weeks intensive</div>
              </div>
            </div>
        ...
        return (
          <div className="space-y-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h2 className="text-lg font-medium mb-2 text-slate-900 dark:text-slate-100" data-testid="text-tab-title">Funding & Discounts</h2>
                <p className="text-slate-600 dark:text-slate-300">We believe every child deserves access to quality STEM education.</p>
              </div>
            </div>
            <div className="grid gap-4">
              <div className="p-4 rounded-lg border border-slate-200 dark:border-slate-600 bg-slate-50 dark:bg-slate-700/30">
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="font-medium text-slate-900 dark:text-slate-100">Merit Scholarships</h3>
                    <p className="text-sm text-slate-600 dark:text-slate-300">For outstanding academic performers</p>
                  </div>
              ...
              <div className="p-4 rounded-lg border border-slate-200 dark:border-slate-600 bg-slate-50 dark:bg-slate-700/30">
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="font-medium text-slate-900 dark:text-slate-100">Sibling Discount</h3>
                    <p className="text-sm text-slate-600 dark:text-slate-300">15% off for each additional child</p>
                  </div>
              ...
              <div className="p-4 rounded-lg border border-slate-200 dark:border-slate-600 bg-slate-50 dark:bg-slate-700/30">
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="font-medium text-slate-900 dark:text-slate-100">Early Registration</h3>
                    <p className="text-sm text-slate-600 dark:text-slate-300">Register 30 days before term starts</p>
                  </div>
              ...
              <div className="p-4 rounded-lg border border-slate-200 dark:border-slate-600 bg-slate-50 dark:bg-slate-700/30">
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="font-medium text-slate-900 dark:text-slate-100">Financial Aid</h3>
                    <p className="text-sm text-slate-600 dark:text-slate-300">Need-based assistance for qualifying families</p>
                  </div>
                  <span className="text-sm px-3 py-1 rounded-full bg-slate-200 dark:bg-slate-600 text-slate-700 dark:text-slate-200">Available</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex items-center gap-4">
            <div className="w-16 h-16 rounded-xl bg-[#1E9AD6] flex items-center justify-center">
              <svg viewBox="0 0 80 80" className="w-10 h-10 text-white" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
                <path d="M20 25H60"/>
                <path d="M30 25V60"/>
            ...
            <div>
              ...
              <p className="text-slate-300 text-sm">Science, Technology, Engineering & Mathematics</p>
            </div>
          </div>
        </div>
      </div>
